...
The first thing to say: there is no need to read this book front to back. The six parts each stand on their own, [Overview and History](./part1overview), [Language Features](./part2lang), [Concurrency](./part3concurrency), [Memory](./part4memory), [Compiler and Toolchain](./part5toolchain), and [Heterogeneous Compute and AI](./part6hetero). They reference one another, but they are not levels you must clear in order. A reader is free to enter through whichever part they care about most, and to go back and fill in any prerequisite concept they do not yet understand.
