...
根据第一次 GC 得到的结果，估计得到的堆增长率为 $h_T(2) = h_T(1) + 0.5\left\{1 - h_T(1) - \frac{0.25 \times 1.3}{0.3} \left[0.0031 - h_T(1)\right] \right\} $$= 0.9375 + 0.5 (1 - 0.9375 - 1.083(0.0031 - 0.9375)) \approx 1.4747$，数值超过 0.95，因此最终的 $h_T(2) = 0.95$，则再次触发 GC 时的堆大小为 0.95*4MB = 3.8 MB。
