...
7. Phil Hofer 等. *runtime: scheduler is slow when goroutines are frequently woken*. Go
   issue #18237, 2016. https://github.com/golang/go/issues/18237 （自旋 M 唤醒延迟的实测）
8. 本书 [9.2 调度策略](./steal.md)、[9.3 G、M、P 与状态机](./mpg.md)、
